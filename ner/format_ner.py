...
def merge_data():
    with open('./data/NER/ner_dataset_french_2.txt', 'r+') as f_2:
        with open('./data/NER/ner_dataset_french.txt', 'r+') as f:
            ...
            with open('./data/NER/ner_dataset_french_3.txt', 'w+') as output:
